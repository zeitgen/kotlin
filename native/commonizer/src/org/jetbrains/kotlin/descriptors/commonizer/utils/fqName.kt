...
internal val DEPRECATED_ANNOTATION_CLASS_ID: CirEntityId = CirEntityId.create(Deprecated::class)

internal val ANY_CLASS_ID: CirEntityId = CirEntityId.create(Any::class)
private val NOTHING_CLASS_ID: CirEntityId = CirEntityId.create(Nothing::class)
