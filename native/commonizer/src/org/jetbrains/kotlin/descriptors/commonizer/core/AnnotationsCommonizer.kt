...
private class DeprecatedAnnotationCommonizer : Commonizer<CirAnnotation, CirAnnotation> {
    ...
    companion object {
        ...
        private val REPLACE_WITH_ANNOTATION_TYPE = buildAnnotationType(CirEntityId.create(ReplaceWith::class))

        private val DEPRECATION_LEVEL_CLASS_ID = CirEntityId.create(DeprecationLevel::class)
