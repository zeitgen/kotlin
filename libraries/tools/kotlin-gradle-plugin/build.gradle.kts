...
dependencies {
    implementation(project(":kotlin-gradle-plugin-api"))
    implementation(project(":kotlin-gradle-plugin-model"))
    ...
    api("com.google.code.gson:gson:${rootProject.extra["versions.jar.gson"]}")
