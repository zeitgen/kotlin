...
open class BuildKotlinToolingMetadataTask : DefaultTask() {
    ...
    fun buildKotlinToolingMetadata(): KotlinToolingMetadata {
        return project.kotlinExtension.buildKotlinToolingMetadata()
    }
    ...
    internal fun createToolingMetadataFile() {
        ...
        outputFile.writeText(buildKotlinToolingMetadata().toJsonString())
    }
}

private fun KotlinProjectExtension.buildKotlinToolingMetadata(): KotlinToolingMetadata {
