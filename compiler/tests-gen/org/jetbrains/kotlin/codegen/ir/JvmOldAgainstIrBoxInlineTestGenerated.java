...
public class JvmOldAgainstIrBoxInlineTestGenerated extends AbstractJvmOldAgainstIrBoxInlineTest {
    ...
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class Invokedynamic extends AbstractJvmOldAgainstIrBoxInlineTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTestWithCustomIgnoreDirective(this::doTest, TargetBackend.JVM_MULTI_MODULE_OLD_AGAINST_IR, testDataFilePath, "// IGNORE_BACKEND_MULTI_MODULE: ");
        }
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class Lambdas extends AbstractJvmOldAgainstIrBoxInlineTest {
            private void runTest(String testDataFilePath) throws Exception {
                KotlinTestUtils.runTestWithCustomIgnoreDirective(this::doTest, TargetBackend.JVM_MULTI_MODULE_OLD_AGAINST_IR, testDataFilePath, "// IGNORE_BACKEND_MULTI_MODULE: ");
            }
