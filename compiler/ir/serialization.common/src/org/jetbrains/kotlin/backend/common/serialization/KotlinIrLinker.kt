...
//                val descriptor = resolveSpecialSignature(idSig)
        ...
        open fun createIrDeserializerForFile(fileProto: ProtoFile, fileIndex: Int, moduleDeserializer: IrModuleDeserializer, allowErrorNodes: Boolean) =
        ...
        private fun deserializeIrFile(fileProto: ProtoFile, fileIndex: Int, moduleDeserializer: IrModuleDeserializer, allowErrorNodes: Boolean): IrFile {
            ...
            val fileDeserializer = createIrDeserializerForFile(fileProto, fileIndex, moduleDeserializer, allowErrorNodes).apply {
