class Test1<<!GENERIC_THROWABLE_SUBCLASS!>T<!>, B> : Exception() {
     <!INNER_CLASS_OF_GENERIC_THROWABLE_SUBCLASS!>inner class Test2<<!GENERIC_THROWABLE_SUBCLASS!>S<!>> : Throwable()<!>
     class Test3 : NullPointerException()
     object Test4 : Throwable() {}
}

class Test5<T, B> {
     <!INNER_CLASS_OF_GENERIC_THROWABLE_SUBCLASS!>inner class Test6 : Exception()<!>
